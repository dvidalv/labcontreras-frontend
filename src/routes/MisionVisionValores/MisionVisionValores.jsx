    ...
    <div className="historia__hero">
      <div className="historia">
        ...
        <div className="historia__vision">
          ...
          <p className="historia__texto">
            Ofrecemos a nuestros pacientes servicios de patología de excelencia
            en la prevención, diagnóstico, tratamiento y seguimiento para la
            toma de las mejores decisiones clínicas por medio de la innovación y
            el uso de tecnología avanzada. Contribuimos con la protección del
            medio ambiente.
          </p>
        </div>
        ...
        <div className="historia__principios">
          <div className="historia__imagen">
            <div className="historia__imagen-container">
              <FaHandshake size={28} color="white" />
            </div>
