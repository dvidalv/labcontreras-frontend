...
import EmpresasSugerencias from "./components/EmpresasSugerencias";
...
function EmpresasSugerenciasPage() {
  ...
  return (
    <div className="sugerencias-container" style={style}>
      ...
      <h2 className="animate__animated animate__backInDown">
        Encuesta de Satisfacción - Empresas
      </h2>
      <EmpresasSugerencias onSubmitSuccess={handleSubmitSuccess} />
    </div>
  );
}

export default EmpresasSugerenciasPage;
